...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onThePurchaseOrdersList.onTable().iCheckColumns(undefined, {"{purchaseOrder}":{"header":"Purchase Order"},"{supplier}":{"header":"Supplier"},"{buyer}":{"header":"Buyer"},"{orderDate}":{"header":"Order Date"},"{deliveryDate}":{"header":"Delivery Date"},"{status}":{"header":"Status"},"{totalAmount}":{"header":"Total Amount"},"{currency}":{"header":"Currency"}});
